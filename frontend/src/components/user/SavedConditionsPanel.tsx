...
function toDraft(conditions: UserSavedConditions | null): UserSavedConditions {
  return {
...
function formatSavedConditionsSummary(
  ...
  if (conditions.category) {
    ...
    parts.push(
      knownCategory ? getCategoryLabel(knownCategory) : conditions.category,
    );
  }
...
function parseDraft(draft: UserSavedConditions): UserSavedConditions {
...
function buildConditionsKey(conditions: UserSavedConditions | null): string {
  if (conditions === null) {
    return 'empty';
  }
