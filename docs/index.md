...
| `FE-ROUTER-RSC-ADVISORY` | 현재 client-only Frontend가 보고하는 React Router RSC advisory high 2건 검토 | `action-needed` | Frontend, ChatGPT 데스크톱 Browser 회귀 | F3 clean install·audit·test·lint·build와 route HTTP 200을 확인함. 데스크톱 Browser에서 렌더링·탐색·console을 확인하고 결과를 기록한 뒤 완료 | [React Router Advisory 계획](development/develop_plan/frontend/02_react_router_advisory.md), [React Router Advisory 개발 기록](development/development_notes/frontend/react_router_advisory.md) |
