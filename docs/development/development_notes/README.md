...
| Supplemental Official Policy Ingestion | [개발 기록](data/supplemental_official_policy_ingestion.md) | SOP0~SOP4 | 공식 Source 제한 actual·KOSAF DB/API 인수·`SOP-G4_BLOCKED` 판정 |
