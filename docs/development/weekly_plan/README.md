...
| 6주차 | Production Data Refresh·배포 파이프라인과 Final Release `v1.0.0` | in-progress (`W6-P2_QUEUE_PASS`) | [6주차 상세 계획](week_06_final_release.md) |
...
| 6주차 | Data·Team Leader·Integration·Deploy | in-progress (`W6-P2_QUEUE_PASS`) | [Final Release 계획](week_06_final_release.md) |
