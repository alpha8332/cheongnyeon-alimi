...
| 4주차 | 공식 웹 Source·지역 고유·보완 공식 정책·자격요건과 사용자·관리자 기본 기능 완성 | in progress | [4주차 상세 계획](week_04_v0_5_0.md) |
| 5주차 | 안정화·사용자 검증과 Release 2 `v0.5.0` 판정 | approved (4주차 완료 뒤 착수) | [5주차 상세 계획](week_05_release_2.md) |
...
발행됐고 `develop`도 같은 커밋으로 동기화됐다. 5주차 계획은 4주차 전체 기본
기능과 `W4-G4_MIDPOINT_PASS`를 선행 조건으로 승인했으며, 6주차는 선행 Gate와
