...
- 후속 Forest: Backend 04·05, Frontend 03·05, Data 03, Integration 06·07

## 목적

4주차 구현 전에 사용자 저장 경계, 관리자 인증·권한, 추천 의미, 수동 수집과
품질 노출 계약을 공동 승인한다. 승인 전에는 각 담당자가 서로 다른 인증,
DTO, 저장 위치나 알림 주체를 구현하지 않는다.
