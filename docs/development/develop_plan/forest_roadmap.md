...
| 2 | [Integration 03 Policy Search Data Foundation](integration/03_policy_search_data_foundation.md) | Data·Backend 공동 | Frontend 소비·Team Leader Gate | in-progress | PSF0~PSF7 계약·지역 기준정보·mapping·원자적 적재·판정·소비·성능·actual 재생 완료, Mock UI 배지 표시 인계 후 최종 Gate 대기 | Data 02 DT1 |
