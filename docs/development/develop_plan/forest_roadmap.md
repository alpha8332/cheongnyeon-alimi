...
| 11 | [Data 05 Regional Youth Policy Ingestion](data/05_regional_youth_policy_ingestion.md) | Data | Team Leader Source·actual Gate, Backend·Frontend 회귀 검토 | in-progress | 광역자치단체 공식 포털 탐색, 지역 고유 정책 판정, 온통청년·복지로 중복 제외와 실제 DB 적재 | Data 03·04, Integration 08 |
