...
| 5 | [Integration 04 Release 1 Acceptance](integration/04_release_1_acceptance.md) | Team Leader - Integration | Data·Backend·Frontend, 리뷰어 사전 확인, QA smoke | in-progress (`IA3C 완료`, `G4 blocked`) | golden 기술·기간 안전성 통과, FE 실제 API·독립 근거 부재로 릴리스 차단 | Data 02, Integration 03, Backend 06, Frontend 04 |
