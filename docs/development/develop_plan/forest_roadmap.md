...
| 6 | [Integration 08 Eligibility Evidence and Summary](integration/08_eligibility_evidence_summary.md) | Data·Backend·Frontend | Team Leader 계약·실제 E2E | in-progress | Eligibility Summary 1.0.0 승인, 핵심 신청 조건·제외·서류·확인 필요와 근거 있는 상세 UI | Integration 05, Data 04 병렬 보강 |
