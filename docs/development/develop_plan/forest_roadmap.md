...
| 11 | [Data 05 Regional Youth Policy Ingestion](data/05_regional_youth_policy_ingestion.md) | Data | Team Leader Source·actual Gate, Backend·Frontend 회귀 검토 | completed | 13개 승인 Source 4,606건 전체 판정, 온통청년·복지로 중복 제외와 accepted 18건 실제 DB 동기화 | Data 03·04, Integration 08 |
