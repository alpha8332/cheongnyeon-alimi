...
| 5 | [Integration 04 Release 1 Acceptance](integration/04_release_1_acceptance.md) | Team Leader - Integration | Data·Backend·Frontend, 리뷰어 사전 확인, QA smoke | in-progress | 실제 DB → API → UI, golden query, Browser와 릴리스 체크 | Data 02, Integration 03, Backend 06, Frontend 04 |
