...
| 5 | [Integration 04 Release 1 Acceptance](integration/04_release_1_acceptance.md) | Team Leader - Integration | Data·Backend·Frontend, 리뷰어 사전 확인, QA smoke | in-progress (`G4 blocked`) | 실제 DB → API → UI 통과, golden confirmed 0·독립 근거 부재로 릴리스 차단 | Data 02, Integration 03, Backend 06, Frontend 04 |
