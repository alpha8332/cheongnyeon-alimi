...
| 14 | [Integration 10 Review Admission and Deploy Handoff](integration/10_review_admission_docker_acceptance.md) | Team Leader - Integration | Data review 판정, Backend·Frontend 영향 확인 | in-progress | RA0 기준선·보호와 RA1 inventory·표본·taxonomy 완료, admission 구현·partial 적재·새 실제 DB 기준선·`W5-G1_REVALIDATED`·Deploy 입력 인계 | Integration 07 W5-G1 |
