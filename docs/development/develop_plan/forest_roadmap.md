...
| 14 | [Integration 10 Review Admission and Deploy Handoff](integration/10_review_admission_docker_acceptance.md) | Team Leader - Integration | Data review 판정, Backend·Frontend 영향 확인 | in-progress | RA0~RA3 통과·taxonomy v2·현재성 재판정 3건 적재·멱등성 완료, RA4 새 실제 DB 기준선·`W5-G1_REVALIDATED`·Deploy 입력 인계 | Integration 07 W5-G1 |
