...
| 5 | [Integration 04 Release 1 Acceptance](integration/04_release_1_acceptance.md) | Team Leader - Integration | Data·Backend·Frontend, 리뷰어 사전 확인, QA smoke | in-progress (`IA3E 증거 기반 완료·담당자 실행 대기`, `G4 blocked`) | golden 기술·기간 안전성·FE actual 검증과 증거 정합성 기반 완료, 독립 QA·사용성·보고서 결과 대기 | Data 02, Integration 03, Backend 06, Frontend 04 |
