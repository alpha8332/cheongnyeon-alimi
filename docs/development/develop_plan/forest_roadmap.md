...
| 2 | [Integration 03 Policy Search Data Foundation](integration/03_policy_search_data_foundation.md) | Data·Backend 공동 | Frontend 소비·Team Leader Gate | in-progress | PSF0~PSF6 계약·공식 지역 기준정보·Source mapping·원자적 적재·3값 판정 primitive 완료, 소비·성능 검증 대기 | Data 02 DT1 |
