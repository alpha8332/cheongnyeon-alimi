...
| 2 | [Integration 03 Policy Search Data Foundation](integration/03_policy_search_data_foundation.md) | Data·Backend 공동 | Frontend 소비·Team Leader Gate | in-progress | PSF0~PSF4 계약·공식 지역 기준정보·PostgreSQL 저장·Source mapping 완료, transaction·판정 primitive 구현 중 | Data 02 DT1 |
