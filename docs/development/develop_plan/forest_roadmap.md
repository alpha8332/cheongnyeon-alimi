...
| 6 | [Integration 08 Eligibility Evidence and Summary](integration/08_eligibility_evidence_summary.md) | Data·Backend·Frontend | Team Leader 계약·실제 E2E | in-progress | ES2 Normalized 1.2·DB·상세 API 완료, ES3 핵심 신청 조건·제외·서류·문의처 UI 대기 | Integration 05, Data 04 병렬 보강 |
