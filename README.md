...
| 영역 | 제공 기능 |
| --- | --- |
| 정책 찾기 | 검색어, 지역, 연령, 관심 분야와 신청 상태로 정책 검색 |
| 신청정보 확인 | 핵심 조건, 지원 내용, 신청 기간, D-Day와 공식 원문 확인 |
| 맞춤 추천 | 저장한 지역·연령·복수 관심 분야에 맞는 정책과 추천 이유 제공 |
| 관심 정책 관리 | 즐겨찾기 폴더, 마감 알림, 달력과 `.ics` 일정 다운로드 |
